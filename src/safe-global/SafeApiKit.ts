...
} from '@safe-global/api-kit/dist/src/types/safeTransactionServiceTypes'
import { getTxServiceBaseUrl } from '@safe-global/api-kit/dist/src/utils'
import { HttpMethod, sendRequest } from '@safe-global/api-kit/dist/src/utils/httpRequests'
import {
  EthAdapter,
...
class SafeApiKit {
  private txServiceBaseUrl: string
