...
export class StakingContract {
  ...
  public delegateEncodeABI(delegatorAddress: string, validatorAddress: string, amount: string) {
    const amountWei = toWei(amount, 'ether');
    const delegatorAddressHex = toChecksumAddress(delegatorAddress);
    const validatorAddressHex = toChecksumAddress(validatorAddress);

    return this.contract.methods.Delegate(
      delegatorAddressHex,
      validatorAddressHex,
      amountWei
    ).encodeABI()
  ...
  public unDelegateEncodeABI(
    ...
    return this.contract.methods.Undelegate(
      delegatorAddressHex,
      validatorAddressHex,
      amountWei
    ).encodeABI();
